...
to {
  ...
  animation: ${Q} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,K=({toast:e})=>{let{icon:t,type:r,iconTheme:s}=e;return void 0!==t?"string"==typeof t?a.createElement(X,null,t):t:"blank"===r?null:a.createElement(U,null,a.createElement(P,{...s}),"loading"!==r&&a.createElement(F,null,"error"===r?a.createElement(z,{...s}):a.createElement(B,{...s})))},V=f("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`];return{animation:t?`${h(s)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${h(a)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}})(e.position||t||"top-center",e.visible):{opacity:0},o=a.createElement(K,{toast:e}),n=a.createElement(Z,{...e.ariaProps},y(e.message,e));return a.createElement(V,{className:e.className,style:{...i,...r,...e.style}},"function"==typeof s?s({icon:o,message:n}):a.createElement(a.Fragment,null,o,n))});s=a.createElement,d.p=void 0,u=s,m=void 0,b=void 0;var G=({id:e,className:t,style:r,onHeightUpdate:s,children:i})=>{let o=a.useCallback(t=>{if(t){let r=()=>{s(e,t.getBoundingClientRect().height)};r(),new MutationObserver(r).observe(t,{subtree:!0,childList:!0,characterData:!0})}},[e,s]);return a.createElement("div",{ref:o,className:t,style:r},i)},W=p`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`;e.s(["Toaster",0,({reverseOrder:e,position:t="top-center",toastOptions:r,gutter:s,children:i,toasterId:o,containerStyle:n,containerClassName:l})=>{let{toasts:d,handlers:c}=((e,t="default")=>{let{toasts:r,pausedAt:s}=((e={},t=j)=>{let[r,s]=(0,a.useState)(k[t]||C),i=(0,a.useRef)(k[t]);(0,a.useEffect)(()=>(i.current!==k[t]&&s(k[t]),w.push([t,s]),()=>{let e=w.findIndex(([e])=>e===t);e>-1&&w.splice(e,1)}),[t]);let o=r.toasts.map(t=>{var r,s,a;return{...e,...e[t.type],...t,removeDelay:t.removeDelay||(null==(r=e[t.type])?void 0:r.removeDelay)||(null==e?void 0:e.removeDelay),duration:t.duration||(null==(s=e[t.type])?void 0:s.duration)||(null==e?void 0:e.duration)||O[t.type],style:{...e.style,...null==(a=e[t.type])?void 0:a.style,...t.style}}});return{...r,toasts:o}})(e,t),i=(0,a.useRef)(new Map).current,o=(0,a.useCallback)((e,t=I)=>{if(i.has(e))return;let r=setTimeout(()=>{i.delete(e),n({type:4,toastId:e})},t);i.set(e,r)},[]);(0,a.useEffect)(()=>{if(s)return;let e=Date.now(),a=r.map(r=>{if(r.duration===1/0)return;let s=(r.duration||0)+r.pauseDuration-(e-r.createdAt);if(s<0){r.visible&&S.dismiss(r.id);return}return setTimeout(()=>S.dismiss(r.id,t),s)});return()=>{a.forEach(e=>e&&clearTimeout(e))}},[r,s,t]);let n=(0,a.useCallback)($(t),[t]),l=(0,a.useCallback)(()=>{n({type:5,time:Date.now()})},[n]),d=(0,a.useCallback)((e,t)=>{n({type:1,toast:{id:e,height:t}})},[n]),c=(0,a.useCallback)(()=>{s&&n({type:6,time:Date.now()})},[s,n]),x=(0,a.useCallback)((e,t)=>{let{reverseOrder:s=!1,gutter:a=8,defaultPosition:i}=t||{},o=r.filter(t=>(t.position||i)===(e.position||i)&&t.height),n=o.findIndex(t=>t.id===e.id),l=o.filter((e,t)=>t<n&&e.visible).length;return o.filter(e=>e.visible).slice(...s?[l+1]:[0,l]).reduce((e,t)=>e+(t.height||0)+a,0)},[r]);return(0,a.useEffect)(()=>{r.forEach(e=>{if(e.dismissed)o(e.id,e.removeDelay);else{let t=i.get(e.id);t&&(clearTimeout(t),i.delete(e.id))}})},[r,o]),{toasts:r,handlers:{updateHeight:d,startPause:l,endPause:c,calculateOffset:x}}})(r,o);return a.createElement("div",{"data-rht-toaster":o||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...n},className:l,onMouseEnter:c.startPause,onMouseLeave:c.endPause},d.map(r=>{let o,n,l=r.position||t,d=c.calculateOffset(r,{reverseOrder:e,gutter:s,defaultPosition:t}),x=(o=l.includes("top"),n=l.includes("center")?{justifyContent:"center"}:l.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:v()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${d*(o?1:-1)}px)`,...o?{top:0}:{bottom:0},...n});return a.createElement(G,{id:r.id,key:r.id,onHeightUpdate:c.updateHeight,className:r.visible?W:"",style:x},"custom"===r.type?y(r.message,r):i?i(r):a.createElement(q,{toast:r,position:l}))}))},"default",0,S,"toast",0,S],5766)},7081,e=>{"use strict";var t=e.i(43476),r=e.i(71645),s=e.i(75157),a=e.i(50719);let i=(0,r.forwardRef)(({value:e,onChange:i,placeholder:o="بحث...",className:n},l)=>{let[d,c]=(0,r.useState)(""),x=void 0!==e,p=x?e:d,u=e=>{x||c(e),i?.(e)};return(0,t.jsxs)("div",{className:(0,s.cn)("relative",n),children:[(0,t.jsx)(a.HiSearch,{className:"absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-text-tertiary pointer-events-none"}),(0,t.jsx)("input",{ref:l,value:p,onChange:e=>u(e.target.value),placeholder:o,className:"w-full bg-card border border-border rounded-[14px] pr-10 pl-9 py-2.5 text-sm text-text placeholder-text-tertiary/50 focus:outline-none focus:ring-2 focus:ring-primary/15 focus:border-primary/30 transition-all duration-200"}),p&&(0,t.jsx)("button",{onClick:()=>u(""),className:"absolute left-2.5 top-1/2 -translate-y-1/2 text-text-tertiary hover:text-text transition-colors",children:(0,t.jsx)(a.HiX,{className:"w-4 h-4"})})]})});i.displayName="SearchInput",e.s(["SearchInput",0,i])},32098,e=>{"use strict";var t=e.i(43476),r=e.i(71645),s=e.i(75157),a=e.i(46932),i=e.i(88653),o=e.i(50719);let n={sm:"max-w-md",md:"max-w-lg",lg:"max-w-2xl",xl:"max-w-4xl"};e.s(["Modal",0,function({open:e,onClose:l,title:d,children:c,className:x,size:p="md"}){let u=(0,r.useCallback)(e=>{"Escape"===e.key&&l()},[l]);return(0,r.useEffect)(()=>(e&&(document.addEventListener("keydown",u),document.body.style.overflow="hidden"),()=>{document.removeEventListener("keydown",u),document.body.style.overflow=""}),[e,u]),(0,t.jsx)(i.AnimatePresence,{children:e&&(0,t.jsxs)("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4",children:[(0,t.jsx)(a.motion.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},className:"absolute inset-0 bg-black/40 backdrop-blur-sm",onClick:l}),(0,t.jsxs)(a.motion.div,{initial:{opacity:0,scale:.95,y:10},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.95,y:10},transition:{type:"spring",stiffness:300,damping:30},className:(0,s.cn)("relative w-full bg-card/90 backdrop-blur-2xl border border-border rounded-[20px] shadow-[0_24px_80px_rgba(217,119,6,0.06)]",n[p],x),children:[d&&(0,t.jsxs)("div",{className:"flex items-center justify-between px-6 pt-6 pb-4",children:[(0,t.jsx)("h3",{className:"text-lg font-semibold text-text",children:d}),(0,t.jsx)("button",{onClick:l,className:"p-1.5 rounded-[10px] hover:bg-card/80 text-text-secondary hover:text-text transition-colors",children:(0,t.jsx)(o.HiX,{className:"w-5 h-5"})})]}),(0,t.jsx)("div",{className:(0,s.cn)("px-6 pb-6",!d&&"pt-6"),children:c})]})]})})}])},3812,e=>{"use strict";var t=e.i(43476),r=e.i(71645),s=e.i(75157);let a=(0,r.forwardRef)(({label:e,error:r,leftIcon:a,rightIcon:i,className:o,...n},l)=>(0,t.jsxs)("div",{className:"space-y-1.5",children:[e&&(0,t.jsx)("label",{className:"block text-sm font-medium text-text-secondary",children:e}),(0,t.jsxs)("div",{className:"relative",children:[a&&(0,t.jsx)("div",{className:"absolute right-3 top-1/2 -translate-y-1/2 text-text-tertiary pointer-events-none",children:a}),(0,t.jsx)("input",{ref:l,className:(0,s.cn)("w-full bg-card border border-border rounded-[14px] px-4 py-2.5 text-sm text-text placeholder-text-tertiary/50","shadow-[0_2px_8px_rgba(217,119,6,0.015),0_1px_0_rgba(255,255,255,0.9)_inset]","transition-all duration-200","focus:outline-none focus:ring-2 focus:ring-primary/15 focus:border-primary/30","hover:border-border-light",r&&"border-error/40 focus:ring-error/15 focus:border-error/50",a&&"pr-10",i&&"pl-10",o),...n}),i&&(0,t.jsx)("div",{className:"absolute left-3 top-1/2 -translate-y-1/2 text-text-tertiary",children:i})]}),r&&(0,t.jsx)("p",{className:"text-xs text-error pr-1",children:r})]}));a.displayName="Input",e.s(["default",0,a])},47647,e=>{"use strict";var t=e.i(43476),r=e.i(75157);e.s(["Table",0,function({children:e,className:s}){return(0,t.jsx)("div",{className:(0,r.cn)("w-full overflow-auto",s),children:(0,t.jsx)("table",{className:"w-full border-collapse",children:e})})}])},73816,e=>{"use strict";var t=e.i(43476),r=e.i(71645),s=e.i(5766),a=e.i(18566),i=e.i(50719),o=e.i(37757),n=e.i(96640),l=e.i(47647),d=e.i(32098),c=e.i(97591),x=e.i(7081),p=e.i(59544),u=e.i(3812),m=e.i(67073),b=e.i(39964),h=e.i(81604),f=e.i(40803),y=e.i(75157);let g={new:"success",used:"neutral",expired:"error"},v={new:"جديد",used:"مستخدم",expired:"منتهي"};e.s(["default",0,function(){let e=(0,a.useRouter)(),[j,N]=(0,r.useState)(""),[w,C]=(0,r.useState)("all"),[k,_]=(0,r.useState)(!1),E=(0,r.useMemo)(()=>({total:h.mockCenterCodes.length,used:h.mockCenterCodes.filter(e=>"used"===e.status).length,available:h.mockCenterCodes.filter(e=>"new"===e.status).length,expired:h.mockCenterCodes.filter(e=>"expired"===e.status).length}),[]),$=(0,r.useMemo)(()=>{let e=new Map;return h.mockCenterCodes.forEach(t=>{let r=e.get(t.batchId)||[];r.push(t),e.set(t.batchId,r)}),Array.from(e.entries()).map(([e,t])=>({batch:e,total:t.length,used:t.filter(e=>"used"===e.status).length,available:t.filter(e=>"new"===e.status).length,totalValue:t.reduce((e,t)=>e+t.price,0)}))},[]),O=(0,r.useMemo)(()=>h.mockCenterCodes.filter(e=>{let t=e.code.includes(j)||e.planName.includes(j),r="all"===w||e.status===w;return t&&r}),[j,w]);return(0,t.jsxs)("div",{className:"p-4 md:p-6 space-y-6",children:[(0,t.jsx)(o.PageHeader,{title:"إدارة الأكواد",description:"إنشاء وإدارة أكواد الاشتراك"}),(0,t.jsxs)("div",{className:"grid grid-cols-2 lg:grid-cols-4 gap-4",children:[(0,t.jsx)(c.StatsCard,{title:"إجمالي الأكواد",value:E.total,icon:i.HiOutlineTag,color:"primary"}),(0,t.jsx)(c.StatsCard,{title:"المتاح",value:E.available,icon:i.HiOutlineCheckCircle,color:"success"}),(0,t.jsx)(c.StatsCard,{title:"المستخدم",value:E.used,icon:i.HiOutlineClock,color:"warning"}),(0,t.jsx)(c.StatsCard,{title:"منتهي الصلاحية",value:E.expired,icon:i.HiOutlineXCircle,color:"error"})]}),(0,t.jsxs)("div",{className:"flex flex-col md:flex-row gap-3 items-start md:items-center justify-between",children:[(0,t.jsxs)("div",{className:"flex flex-1 gap-3 w-full",children:[(0,t.jsx)("div",{className:"flex-1",children:(0,t.jsx)(x.SearchInput,{value:j,onChange:N,placeholder:"بحث بالكود أو الباقة..."})}),(0,t.jsxs)("select",{value:w,onChange:e=>C(e.target.value),className:"px-3 py-2 bg-surface border border-border rounded-xl text-sm text-text focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all cursor-pointer",children:[(0,t.jsx)("option",{value:"all",children:"جميع الحالات"}),(0,t.jsx)("option",{value:"new",children:"جديد"}),(0,t.jsx)("option",{value:"used",children:"مستخدم"}),(0,t.jsx)("option",{value:"expired",children:"منتهي"})]})]}),(0,t.jsx)(p.default,{leftIcon:(0,t.jsx)(i.HiOutlinePlus,{className:"w-4 h-4"}),onClick:()=>_(!0),children:"إنشاء أكواد جديدة"})]}),0===O.length?(0,t.jsx)(f.EmptyState,{icon:i.HiOutlineQrcode,title:"لا يوجد أكواد",description:"لم يتم إنشاء أي أكواد تفعيل بعد"}):(0,t.jsx)(l.Table,{columns:[{key:"code",header:"الكود",render:r=>(0,t.jsxs)("div",{className:"flex items-center gap-2",children:[(0,t.jsx)("span",{className:"font-mono text-sm font-bold text-text cursor-pointer hover:text-primary transition-colors",dir:"ltr",onClick:()=>e.push(`/teacher/codes/${r.code}`),children:r.code}),(0,t.jsx)("button",{type:"button",className:"p-1 text-text-tertiary hover:text-primary transition-colors",title:"QR Code",onClick:()=>s.default.success("تم عرض رمز QR"),children:(0,t.jsx)(i.HiOutlineQrcode,{size:16})})]})},{key:"planName",header:"الباقة"},{key:"courseName",header:"الكورس",render:r=>(0,t.jsx)("span",{className:"text-sm text-text-secondary cursor-pointer hover:text-primary transition-colors",onClick:()=>e.push("/teacher/courses"),children:r.courseName||"جميع الكورسات"})},{key:"batchId",header:"الدفعة",render:e=>(0,t.jsx)(n.Badge,{variant:"default",size:"sm",children:e.batchId})},{key:"status",header:"الحالة",render:e=>(0,t.jsx)(n.Badge,{variant:g[e.status],children:v[e.status]})},{key:"usedBy",header:"المستخدم",render:e=>(0,t.jsx)("span",{className:"text-sm text-text-secondary",children:e.usedBy||"—"})},{key:"price",header:"السعر",render:e=>(0,t.jsx)("span",{className:"text-sm font-medium",children:(0,y.formatCurrency)(e.price)})},{key:"createdAt",header:"تاريخ الإنشاء",render:e=>(0,t.jsx)("span",{className:"text-xs text-text-tertiary",children:(0,y.formatDate)(e.createdAt)})}],data:O}),(0,t.jsxs)(b.Card,{children:[(0,t.jsx)(b.CardHeader,{children:(0,t.jsx)(b.CardTitle,{children:"ملخص الدفعات"})}),(0,t.jsx)(b.CardContent,{children:(0,t.jsx)("div",{className:"space-y-3",children:$.map(e=>(0,t.jsxs)("div",{className:"flex items-center justify-between p-3 rounded-xl bg-surface-secondary border border-border",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("p",{className:"text-sm font-medium text-text",children:e.batch}),(0,t.jsxs)("p",{className:"text-xs text-text-tertiary",children:["إجمالي ",e.total," كود"]})]}),(0,t.jsxs)("div",{className:"flex items-center gap-4",children:[(0,t.jsxs)("div",{className:"text-center",children:[(0,t.jsx)("p",{className:"text-sm font-bold text-success",children:e.available}),(0,t.jsx)("p",{className:"text-xs text-text-tertiary",children:"متاح"})]}),(0,t.jsxs)("div",{className:"text-center",children:[(0,t.jsx)("p",{className:"text-sm font-bold text-warning",children:e.used}),(0,t.jsx)("p",{className:"text-xs text-text-tertiary",children:"مستخدم"})]}),(0,t.jsxs)("div",{className:"text-center",children:[(0,t.jsx)("p",{className:"text-sm font-bold text-text",children:(0,y.formatCurrency)(e.totalValue)}),(0,t.jsx)("p",{className:"text-xs text-text-tertiary",children:"القيمة"})]})]})]},e.batch))})})]}),(0,t.jsxs)(b.Card,{children:[(0,t.jsx)(b.CardHeader,{children:(0,t.jsx)(b.CardTitle,{children:"إحصائيات الأكواد"})}),(0,t.jsxs)(b.CardContent,{children:[(0,t.jsxs)("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4",children:[(0,t.jsxs)("div",{className:"text-center p-4 rounded-xl bg-surface-secondary border border-border",children:[(0,t.jsx)("p",{className:"text-2xl font-bold text-text",children:E.total}),(0,t.jsx)("p",{className:"text-xs text-text-tertiary mt-1",children:"إجمالي"})]}),(0,t.jsxs)("div",{className:"text-center p-4 rounded-xl bg-success/10 border border-success/20",children:[(0,t.jsx)("p",{className:"text-2xl font-bold text-success",children:E.available}),(0,t.jsx)("p",{className:"text-xs text-text-tertiary mt-1",children:"متاح"})]}),(0,t.jsxs)("div",{className:"text-center p-4 rounded-xl bg-warning/10 border border-warning/20",children:[(0,t.jsx)("p",{className:"text-2xl font-bold text-warning",children:E.used}),(0,t.jsx)("p",{className:"text-xs text-text-tertiary mt-1",children:"مستخدم"})]}),(0,t.jsxs)("div",{className:"text-center p-4 rounded-xl bg-error/10 border border-error/20",children:[(0,t.jsx)("p",{className:"text-2xl font-bold text-error",children:E.expired}),(0,t.jsx)("p",{className:"text-xs text-text-tertiary mt-1",children:"منتهي"})]})]}),(0,t.jsxs)("div",{className:"mt-4 p-3 rounded-xl bg-primary-50/50 dark:bg-primary-900/10 border border-primary/20 text-sm text-text-secondary text-center",children:["إجمالي قيمة الأكواد المتاحة: ",(0,y.formatCurrency)(h.mockCenterCodes.filter(e=>"new"===e.status).reduce((e,t)=>e+t.price,0))]})]})]}),(0,t.jsx)(d.Modal,{isOpen:k,onClose:()=>_(!1),title:"إنشاء أكواد جديدة",subtitle:"أدخل البيانات لإنشاء مجموعة جديدة من الأكواد",size:"lg",children:(0,t.jsxs)("div",{className:"space-y-4",children:[(0,t.jsx)(u.default,{label:"عدد الأكواد",type:"number",placeholder:"مثال: 50"}),(0,t.jsx)(m.default,{label:"الباقة",options:h.mockSubscriptionPlans.map(e=>({value:e.id,label:`${e.name} - ${(0,y.formatCurrency)(e.price)}`})),placeholder:"اختر الباقة"}),(0,t.jsx)(m.default,{label:"الكورس (اختياري)",options:h.mockCourses.map(e=>({value:e.id,label:e.title})),placeholder:"اختر الكورس (اختياري)"}),(0,t.jsx)(u.default,{label:"اسم الدفعة",placeholder:"مثال: الدفعة الأولى 2025"}),(0,t.jsx)(u.default,{label:"تاريخ انتهاء الصلاحية",type:"date"}),(0,t.jsxs)("div",{className:"pt-4 flex gap-3",children:[(0,t.jsx)(p.default,{variant:"primary",size:"lg",className:"flex-1",onClick:()=>{s.default.success("تم إنشاء الأكواد بنجاح"),_(!1)},children:"إنشاء الأكواد"}),(0,t.jsx)(p.default,{variant:"secondary",size:"lg",onClick:()=>_(!1),children:"إلغاء"})]})]})})]})}])}]);