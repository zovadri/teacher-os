...
to {
  ...
  animation: ${U} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Z=({toast:e})=>{let{icon:t,type:r,iconTheme:s}=e;return void 0!==t?"string"==typeof t?a.createElement(K,null,t):t:"blank"===r?null:a.createElement(X,null,a.createElement(M,{...s}),"loading"!==r&&a.createElement(F,null,"error"===r?a.createElement(z,{...s}):a.createElement(R,{...s})))},q=b("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`];return{animation:t?`${h(s)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${h(a)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}})(e.position||t||"top-center",e.visible):{opacity:0},o=a.createElement(Z,{toast:e}),n=a.createElement(G,{...e.ariaProps},g(e.message,e));return a.createElement(q,{className:e.className,style:{...i,...r,...e.style}},"function"==typeof s?s({icon:o,message:n}):a.createElement(a.Fragment,null,o,n))});s=a.createElement,l.p=void 0,m=s,x=void 0,f=void 0;var Y=({id:e,className:t,style:r,onHeightUpdate:s,children:i})=>{let o=a.useCallback(t=>{if(t){let r=()=>{s(e,t.getBoundingClientRect().height)};r(),new MutationObserver(r).observe(t,{subtree:!0,childList:!0,characterData:!0})}},[e,s]);return a.createElement("div",{ref:o,className:t,style:r},i)},J=p`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`;e.s(["Toaster",0,({reverseOrder:e,position:t="top-center",toastOptions:r,gutter:s,children:i,toasterId:o,containerStyle:n,containerClassName:d})=>{let{toasts:l,handlers:c}=((e,t="default")=>{let{toasts:r,pausedAt:s}=((e={},t=j)=>{let[r,s]=(0,a.useState)(k[t]||C),i=(0,a.useRef)(k[t]);(0,a.useEffect)(()=>(i.current!==k[t]&&s(k[t]),N.push([t,s]),()=>{let e=N.findIndex(([e])=>e===t);e>-1&&N.splice(e,1)}),[t]);let o=r.toasts.map(t=>{var r,s,a;return{...e,...e[t.type],...t,removeDelay:t.removeDelay||(null==(r=e[t.type])?void 0:r.removeDelay)||(null==e?void 0:e.removeDelay),duration:t.duration||(null==(s=e[t.type])?void 0:s.duration)||(null==e?void 0:e.duration)||O[t.type],style:{...e.style,...null==(a=e[t.type])?void 0:a.style,...t.style}}});return{...r,toasts:o}})(e,t),i=(0,a.useRef)(new Map).current,o=(0,a.useCallback)((e,t=H)=>{if(i.has(e))return;let r=setTimeout(()=>{i.delete(e),n({type:4,toastId:e})},t);i.set(e,r)},[]);(0,a.useEffect)(()=>{if(s)return;let e=Date.now(),a=r.map(r=>{if(r.duration===1/0)return;let s=(r.duration||0)+r.pauseDuration-(e-r.createdAt);if(s<0){r.visible&&D.dismiss(r.id);return}return setTimeout(()=>D.dismiss(r.id,t),s)});return()=>{a.forEach(e=>e&&clearTimeout(e))}},[r,s,t]);let n=(0,a.useCallback)(E(t),[t]),d=(0,a.useCallback)(()=>{n({type:5,time:Date.now()})},[n]),l=(0,a.useCallback)((e,t)=>{n({type:1,toast:{id:e,height:t}})},[n]),c=(0,a.useCallback)(()=>{s&&n({type:6,time:Date.now()})},[s,n]),u=(0,a.useCallback)((e,t)=>{let{reverseOrder:s=!1,gutter:a=8,defaultPosition:i}=t||{},o=r.filter(t=>(t.position||i)===(e.position||i)&&t.height),n=o.findIndex(t=>t.id===e.id),d=o.filter((e,t)=>t<n&&e.visible).length;return o.filter(e=>e.visible).slice(...s?[d+1]:[0,d]).reduce((e,t)=>e+(t.height||0)+a,0)},[r]);return(0,a.useEffect)(()=>{r.forEach(e=>{if(e.dismissed)o(e.id,e.removeDelay);else{let t=i.get(e.id);t&&(clearTimeout(t),i.delete(e.id))}})},[r,o]),{toasts:r,handlers:{updateHeight:l,startPause:d,endPause:c,calculateOffset:u}}})(r,o);return a.createElement("div",{"data-rht-toaster":o||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...n},className:d,onMouseEnter:c.startPause,onMouseLeave:c.endPause},l.map(r=>{let o,n,d=r.position||t,l=c.calculateOffset(r,{reverseOrder:e,gutter:s,defaultPosition:t}),u=(o=d.includes("top"),n=d.includes("center")?{justifyContent:"center"}:d.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:v()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${l*(o?1:-1)}px)`,...o?{top:0}:{bottom:0},...n});return a.createElement(Y,{id:r.id,key:r.id,onHeightUpdate:c.updateHeight,className:r.visible?J:"",style:u},"custom"===r.type?g(r.message,r):i?i(r):a.createElement(W,{toast:r,position:d}))}))},"default",0,D,"toast",0,D],5766)},17528,e=>{"use strict";var t=e.i(43476),r=e.i(46932),s=e.i(5766),a=e.i(50719),i=e.i(37757),o=e.i(39964),n=e.i(96640),d=e.i(97591),l=e.i(64753);let c=[{id:"r1",student:"أحمد محمد",amount:2e3,date:"2026-07-01",method:"تحويل بنكي",reference:"TXN-001",status:"confirmed"},{id:"r2",student:"مريم أحمد",amount:1e3,date:"2026-07-10",method:"محفظة إلكترونية",reference:"TXN-002",status:"confirmed"},{id:"r3",student:"يوسف علي",amount:500,date:"2026-07-05",method:"كاش",reference:"TXN-003",status:"pending"},{id:"r4",student:"سارة خالد",amount:1500,date:"2026-07-12",method:"فيزا",reference:"TXN-004",status:"confirmed"},{id:"r5",student:"ندى سامي",amount:750,date:"2026-07-08",method:"تحويل بنكي",reference:"TXN-005",status:"confirmed"},{id:"r6",student:"عمر حسن",amount:1800,date:"2026-06-15",method:"كاش",reference:"TXN-006",status:"confirmed"}],u={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.05}}},p={hidden:{opacity:0,y:20},visible:{opacity:1,y:0,transition:{duration:.35}}};e.s(["default",0,function(){let e=c.filter(e=>"confirmed"===e.status).length,m=c.reduce((e,t)=>e+t.amount,0);return(0,t.jsxs)("div",{className:"min-h-screen",children:[(0,t.jsx)(l.Breadcrumb,{items:[{label:"المدفوعات",href:"/teacher/payments/installments"},{label:"الإيصالات"}]}),(0,t.jsx)(i.PageHeader,{title:"الإيصالات",description:"سجل الإيصالات والمبالغ المستلمة"}),(0,t.jsx)("div",{className:"p-4 md:p-6 space-y-6",children:(0,t.jsxs)(r.motion.div,{variants:u,initial:"hidden",animate:"visible",className:"space-y-6",children:[(0,t.jsxs)(r.motion.div,{variants:p,className:"grid grid-cols-1 sm:grid-cols-4 gap-3",children:[(0,t.jsx)(d.StatsCard,{title:"الإيصالات",value:c.length,icon:a.HiOutlineReceiptRefund,color:"primary"}),(0,t.jsx)(d.StatsCard,{title:"مؤكدة",value:e,icon:a.HiOutlineCheckCircle,color:"success"}),(0,t.jsx)(d.StatsCard,{title:"معلقة",value:c.length-e,icon:a.HiOutlineDocumentText,color:"warning"}),(0,t.jsx)(d.StatsCard,{title:"الإجمالي",value:`${m} ج.م`,icon:a.HiOutlineCash,color:"info"})]}),(0,t.jsx)(r.motion.div,{variants:p,children:(0,t.jsxs)(o.Card,{children:[(0,t.jsx)(o.CardHeader,{children:(0,t.jsx)(o.CardTitle,{children:"سجل الإيصالات"})}),(0,t.jsx)(o.CardContent,{children:(0,t.jsx)("div",{className:"space-y-2",children:c.map(e=>(0,t.jsxs)("div",{className:"flex items-center justify-between p-3 rounded-xl bg-surface-secondary border border-border",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)("div",{className:"w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center",children:(0,t.jsx)(a.HiOutlineDocumentText,{className:"w-4 h-4 text-primary"})}),(0,t.jsxs)("div",{children:[(0,t.jsx)("p",{className:"text-sm font-medium text-text",children:e.student}),(0,t.jsxs)("p",{className:"text-xs text-text-tertiary",children:[e.date," - ",e.method," - ",e.reference]})]})]}),(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsxs)("span",{className:"text-sm font-bold text-primary",children:[e.amount," ج.م"]}),(0,t.jsx)(n.Badge,{variant:"confirmed"===e.status?"success":"warning",size:"sm",children:"confirmed"===e.status?"مؤكد":"معلق"}),(0,t.jsx)("button",{type:"button",onClick:()=>s.default.success("جاري تجهيز الطباعة..."),className:"p-1.5 rounded-lg hover:bg-surface transition-colors",children:(0,t.jsx)(a.HiOutlinePrinter,{className:"w-4 h-4 text-text-tertiary"})}),(0,t.jsx)("button",{type:"button",onClick:()=>s.default.success("جاري تحميل الإيصال..."),className:"p-1.5 rounded-lg hover:bg-surface transition-colors",children:(0,t.jsx)(a.HiOutlineDownload,{className:"w-4 h-4 text-text-tertiary"})})]})]},e.id))})})]})})]})})]})}])}]);