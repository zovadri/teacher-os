      ...
      <div className="relative group/nav">
        <Link
          ...
          className={cn(
            ...
            active
              ? "bg-primary-100 text-primary shadow-[0_0_12px_rgba(79,70,229,0.06)]"
        ...
        {!showLabel && (
          <div className="absolute right-14 top-1/2 -translate-y-1/2 z-50 pointer-events-none opacity-0 group-hover/nav:opacity-100 transition-opacity duration-200">
            <div className="bg-card/90 backdrop-blur-2xl border border-border rounded-[10px] px-3 py-1.5 text-sm font-medium text-text whitespace-nowrap shadow-[0_8px_32px_rgba(79,70,229,0.06)]">
              {item.label}
            </div>
          </div>
        )}
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center gap-3 px-6 py-5 border-b border-border">
            ...
            <div className="w-9 h-9 rounded-[12px] bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center text-white font-bold text-sm shadow-[0_0_12px_rgba(79,70,229,0.15)]">T</div>
      ...
      <aside
        ...
        className={cn(
          "hidden lg:flex flex-col fixed right-0 top-0 h-screen z-30 transition-all duration-300 ease-[cubic-bezier(0.25,0.1,0.25,1)] bg-surface/80 backdrop-blur-2xl border-l border-border shadow-[0_0_30px_rgba(79,70,229,0.06)]",
      ...
      >
        <div className={cn(
          ...
          <motion.div
            ...
            className="w-9 h-9 rounded-[12px] bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center text-white font-bold text-sm shrink-0 shadow-[0_0_12px_rgba(79,70,229,0.15)]"
          >
            T
          </motion.div>
          <AnimatePresence>
