...
const colorMap = {
  primary: { bg: "bg-primary-100", text: "text-primary", border: "border-primary-200", gradient: ["#4F46E5", "#3730A3"] },
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_48px_rgba(79,70,229,0.05),0_1px_0_rgba(255,255,255,0.9)_inset] hover:border-border-light relative",
