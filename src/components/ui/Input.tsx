      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          ...
          <input
            ref={ref}
            className={cn(
              "w-full bg-card/60 backdrop-blur-xl border border-border rounded-[14px] px-4 py-2.5 text-sm text-text placeholder-text-tertiary/50",
              "shadow-[0_2px_8px_rgba(124,92,252,0.03),inset_0_1px_0_rgba(255,255,255,0.8)]",
