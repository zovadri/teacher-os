      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          ...
          <input
            ...
            id={inputId}
            className={cn(
              "w-full bg-surface-secondary border border-border rounded-xl px-3.5 py-2.5 text-sm text-text placeholder:text-text-tertiary transition-all duration-200",
