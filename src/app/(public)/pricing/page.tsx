...
export default function PricingPage() {
  ...
  return (
    <>
            ...
            {plans.map((plan, i) => {
              ...
              return (
                <motion.div
                  ...
                  className={`relative p-8 rounded-[24px] border-2 transition-all duration-300 flex flex-col ${isPopular ? "border-primary bg-card shadow-[0_8px_32px_rgba(79,70,229,0.15)] scale-105 md:scale-110" : "border-border bg-card hover:border-primary/20 shadow-[0_1px_3px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.03)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.03)] hover:-translate-y-0.5"}`}
                >
                  ...
                  <Link
                    href="/register"
                    className={`block w-full text-center py-3 rounded-[16px] font-medium transition-all text-[15px] ${isPopular ? "bg-primary text-white shadow-[0_0_20px_rgba(79,70,229,0.15)] hover:shadow-[0_0_30px_rgba(79,70,229,0.3)] hover:brightness-110" : "border border-border text-text-secondary hover:bg-surface-tertiary hover:text-text"}`}
                  >
                    ابدأ الآن
                  </Link>
                </motion.div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <motion.div {...fadeUp} className="relative rounded-[24px] bg-gradient-to-br from-primary to-primary-dark p-8 md:p-16 text-center text-white overflow-hidden shadow-[0_8px_40px_rgba(79,70,229,0.2)]">
