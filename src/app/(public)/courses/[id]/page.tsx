                  ...
                  <div className="space-y-3">
                    {chapters.map((chapter) => (
                      <div key={chapter.id} className="rounded-xl border border-border overflow-hidden">
                        <button type="button" onClick={() => toggleChapter(chapter.id)} className="w-full flex items-center justify-between p-4 bg-surface-secondary hover:bg-surface-tertiary transition-colors text-right">
            ...
            <div className="space-y-6">
              <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="sticky top-28 space-y-6">
                <div className="p-6 rounded-xl border border-border bg-surface shadow-lg">
                  ...
                  <button type="button" className="w-full py-3 bg-primary text-white font-medium rounded-xl hover:bg-primary-dark transition-all shadow-lg shadow-primary/25 mb-3">ط§ط´طھط±ظƒ ط§ظ„ط¢ظ†</button>
                  <button type="button" className="w-full py-3 border border-border text-text-secondary font-medium rounded-xl hover:bg-surface-tertiary transition-all">طھط¬ط±ط¨ط© ظ…ط¬ط§ظ†ظٹط©</button>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <motion.div {...fadeUp} className="relative rounded-2xl bg-gradient-to-br from-primary to-primary-dark p-8 md:p-16 text-center text-white overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <button type="button" className="px-8 py-3 bg-white text-primary font-medium rounded-xl hover:bg-white/90 transition-all">ط§ط´طھط±ظƒ ظپظٹ ط§ظ„ظƒظˆط±ط³</button>
            </div>
          </motion.div>
        </div>
      </section>
