          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/courses" className="px-8 py-3 bg-primary text-white font-medium rounded-xl hover:bg-primary-dark transition-all shadow-lg shadow-primary/25">
                  تصفح الكورسات
                </Link>
                <Link href="/contact" className="px-8 py-3 border border-border text-text-secondary font-medium rounded-xl hover:bg-surface-tertiary transition-all">
                  تواصل معنا
                </Link>
              </div>
            </motion.div>
