                  ...
                  <CardContent className="p-5 space-y-4 flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex gap-3 pt-2">
                      ...
                      <Link href="/login" className="flex-[2]">
                        <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-primary text-white rounded-xl text-sm font-medium hover:bg-primary-dark transition-all duration-200 shadow-sm shadow-primary/20 active:scale-[0.98]">
