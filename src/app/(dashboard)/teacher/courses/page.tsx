    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="flex gap-3">
          ...
          <Link href="/teacher/courses/create">
            <button className="flex items-center gap-2 px-4 py-2 bg-primary text-white text-sm font-medium rounded-xl hover:bg-primary-dark transition-colors shadow-sm">
      ...
      {filtered.length === 0 ? (
        <EmptyState
          ...
          action={
            <Link href="/teacher/courses/create">
              <button className="px-4 py-2 bg-primary text-white text-sm font-medium rounded-xl hover:bg-primary-dark transition-colors">
                إضافة كورس جديد
              </button>
            </Link>
          }
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity" dir="ltr">
                        <button onClick={(e) => { e.preventDefault() }} className="p-1.5 text-text-tertiary hover:text-primary hover:bg-primary/5 rounded-lg transition-colors" title="تعديل">
                          <HiOutlinePencil size={16} />
                        </button>
                        <button onClick={(e) => { e.preventDefault() }} className="p-1.5 text-text-tertiary hover:text-info hover:bg-info/5 rounded-lg transition-colors" title="عرض">
                          <HiOutlineEye size={16} />
                        </button>
                        <button onClick={(e) => { e.preventDefault() }} className="p-1.5 text-text-tertiary hover:text-warning hover:bg-warning/5 rounded-lg transition-colors" title="إخفاء">
