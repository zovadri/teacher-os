    ...
    return (
      <div className="p-4 md:p-6 text-center py-20">
        ...
        <Link href="/teacher/courses">
          <button type="button" className="px-4 py-2 text-sm text-white bg-primary rounded-xl">ط§ظ„ط¹ظˆط¯ط© ظ„ظ„ظƒظˆط±ط³ط§طھ</button>
        </Link>
      </div>
    )
  }
          ...
          <div className="relative h-48 rounded-xl overflow-hidden">
            ...
            <div className="absolute bottom-4 right-4 left-4 flex items-end justify-between">
              ...
              <div className="flex items-center gap-2">
                <button type="button"
                  onClick={() => { setDuplicateName(`ظ†ط³ط®ط© ظ…ظ† ${course.title}`); setDuplicateModalOpen(true) }}
                ...
                <button type="button" className="flex items-center gap-1.5 px-3 py-1.5 bg-white/20 backdrop-blur-sm rounded-lg text-white text-xs font-medium hover:bg-white/30 transition-colors">
