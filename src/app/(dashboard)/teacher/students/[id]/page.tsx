    ...
    return (
      <div className="p-4 md:p-6 text-center py-20">
        ...
        <Link href="/teacher/students">
          <button type="button" className="px-4 py-2 text-sm text-white bg-primary rounded-xl">ط§ظ„ط¹ظˆط¯ط© ظ„ظ„ط·ظ„ط§ط¨</button>
        </Link>
      </div>
    )
  }
      ...
      <div className="bg-surface rounded-xl border border-border p-6">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2">
            <button type="button" className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-primary text-white text-sm font-medium hover:bg-primary-dark transition-colors">
              <HiOutlineMail size={16} /> ط±ط³ط§ظ„ط©
            </button>
            <button type="button" className="flex items-center gap-1.5 px-4 py-2 rounded-xl border border-border text-text-secondary text-sm hover:bg-surface-secondary transition-colors">
              <HiOutlinePrinter size={16} /> ط·ط¨ط§ط¹ط© ط§ظ„ط¨ظٹط§ظ†ط§طھ
            </button>
            <button type="button" onClick={() => setShowQR(true)} className="p-2 rounded-xl border border-border text-text-secondary hover:bg-surface-secondary transition-colors" title="QR Code">
              <HiOutlineQrcode size={18} />
            </button>
            <div className="relative">
              <button type="button" onClick={() => setShowMoreMenu((p) => !p)} className="p-2 rounded-xl border border-border text-text-secondary hover:bg-surface-secondary transition-colors">
                    ...
                    columns={[
                      ...
                      { key: "actions", header: "", render: (c) => (
                        <Link href={`/teacher/courses/${c.id}`}>
                          <button type="button" className="p-1.5 text-text-tertiary hover:text-primary hover:bg-primary/5 rounded-lg transition-colors">
                    ...
                    <Card key={cert.id} hover>
                      <CardContent className="space-y-3">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-border">
                          ...
                          <button type="button" className="flex items-center gap-1 text-xs text-primary hover:text-primary-dark transition-colors">
            ...
            <TabPanel id="devices" activeTab={activeTab}>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button type="button" className="flex items-center gap-1.5 px-4 py-2 text-sm text-error border border-error/30 rounded-xl hover:bg-error/5 transition-colors">
