    ...
    return (
      <div className="p-4 md:p-6 text-center py-20">
        ...
        <Link href="/teacher/homework">
          <button type="button" className="px-4 py-2 text-sm text-white bg-primary rounded-xl">ط·آ§ط¸â€‍ط·آ¹ط¸ث†ط·آ¯ط·آ© ط¸â€‍ط¸â€‍ط¸ث†ط·آ§ط·آ¬ط·آ¨ط·آ§ط·ع¾</button>
        </Link>
      </div>
    )
  }
      ...
      <div className="bg-surface rounded-xl border border-border p-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button type="button" className="flex items-center gap-1.5 px-4 py-2 rounded-xl border border-border text-sm text-text-secondary hover:bg-surface-secondary transition-colors">
              <HiOutlinePencil size={16} /> ط·ع¾ط·آ¹ط·آ¯ط¸ظ¹ط¸â€‍
            </button>
            <button type="button" className="flex items-center gap-1.5 px-4 py-2 rounded-xl border border-border text-error text-sm hover:bg-error/5 transition-colors">
              ...
              <Card>
                ...
                <CardContent className="space-y-6 max-w-2xl">
                  ...
                  <div className="flex items-center gap-3 pt-4">
                    <button type="button" variant="primary" leftIcon={<HiOutlineSave className="w-4 h-4" />}>ط·آ­ط¸ظ¾ط·آ¸ ط·آ§ط¸â€‍ط·ع¾ط·ط›ط¸ظ¹ط¸ظ¹ط·آ±ط·آ§ط·ع¾</Button>
