...
export default function TeacherDashboard() {
  ...
  return (
    <motion.div initial="hidden" animate="visible" className="space-y-6">
      ...
      <motion.div variants={item} className="bg-surface border border-border rounded-[20px] p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            ...
            <Link key={card.title} href={card.href}>
              <div className="bg-surface border border-border rounded-[20px] p-5 transition-all duration-200 hover:border-primary/30">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <motion.div variants={item}>
          <div className="bg-surface border border-border rounded-[20px] p-5 h-full">
            <div className="flex items-center justify-between mb-4">
            ...
            <div className="space-y-2">
              {upcomingExams.map((exam) => {
                ...
                return (
                  <div key={exam.id} onClick={() => router.push(`/teacher/exams/${exam.id}`)} className="rounded-xl border border-border p-3.5 hover:border-primary/30 transition-all duration-200 cursor-pointer">
