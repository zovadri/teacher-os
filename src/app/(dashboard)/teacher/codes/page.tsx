        ...
        columns={[
          { key: "code", header: "الكود", render: (c) => (
            <div className="flex items-center gap-2">
              <span className="font-mono text-sm font-bold text-text" dir="ltr">{c.code}</span>
              <button className="p-1 text-text-tertiary hover:text-primary transition-colors" title="QR Code">
          ...
          { key: "courseName", header: "الكورس", render: (c) => (
            <span className="text-sm text-text-secondary">{c.courseName || "جميع الكورسات"}</span>
          )},
      ...
      <Modal isOpen={showCreateModal} onClose={() => setShowCreateModal(false)} title="إنشاء أكواد جديدة" subtitle="أدخل البيانات لإنشاء مجموعة جديدة من الأكواد" size="lg">
        <div className="space-y-4">
          ...
          <div className="pt-4 flex gap-3">
            <Button variant="primary" size="lg" className="flex-1">إنشاء الأكواد</Button>
