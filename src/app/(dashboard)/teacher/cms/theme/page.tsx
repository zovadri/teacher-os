              ...
              >
                ...
                <div className="p-6 space-y-4 bg-white">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2">
                      <button className="px-4 py-2 text-white text-xs rounded-lg" style={{ backgroundColor: theme.primaryColor, borderRadius: previewStyle.borderRadius }}>ابدأ الآن</button>
                      <button className="px-4 py-2 text-xs rounded-lg border border-gray-200" style={{ borderRadius: previewStyle.borderRadius }}>اعرف المزيد</button>
                    </div>
                  </div>
                </div>
