...
import { HiOutlineTicket, HiOutlineCheckCircle, HiOutlineXCircle, HiOutlinePlus, HiOutlinePercent } from "react-icons/hi"
...
const columns = [
  ...
  { key: "discount", label: "الخصم", render: (r: Coupon) => <span className="text-sm text-text">{r.type === "percentage" ? `${r.discount}%` : `${r.discount} ج.م`}</span> },
      ...
      <div className="p-4 md:p-6 space-y-6">
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
          <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-4 gap-3">
            ...
            <StatsCard title="مرات الاستخدام" value={totalUsage} icon={HiOutlinePercent} color="info" />
          </motion.div>
