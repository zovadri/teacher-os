                ...
                <div className="space-y-4">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-1">
                      <button type="button" onClick={() => handleDownloadPdf(report.id)} className="p-2 rounded-lg hover:bg-surface-secondary text-text-tertiary hover:text-primary transition-colors" title="تحميل PDF">
                        <HiOutlineDownload className="w-4 h-4" />
                      </button>
                      <button type="button" onClick={() => handleViewFull(report.id)} className="p-2 rounded-lg hover:bg-surface-secondary text-text-tertiary hover:text-primary transition-colors" title="عرض التقرير الكامل">
