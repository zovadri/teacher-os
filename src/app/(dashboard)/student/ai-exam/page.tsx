...
const subjectQuestions: Record<Subject, string[]> = {
  chemistry: [
    ...
    "أي العناصر التالية هو أشباه فلزات؟",
    ...
    "ما الفرق بين التفاعل الطارد للحرارة والماص للحرارة؟",
    "كيف يمكنك تحديد عدد التأكسد لعنصر في مركب؟",
    ...
    "ما هي أنواع الروابط الكيميائية وخصائص كل نوع؟",
  ...
  physics: [
    ...
    "أي من الكميات التالية كمية متجهة؟",
    ...
    "ما هي قوانين كيرشوف للدوائر الكهربائية؟",
    "اشرح نظرية النسبية لأينشتاين باختصار",
    "كيف يحدث انكسار الضوء وما هي قوانينه؟",
    "ما الفرق بين الموجات الطولية والمستعرضة؟",
    "اشرح مفهوم المجال المغناطيسي وتطبيقاته",
    "كيف تؤثر درجة الحرارة على مقاومة الموصلات؟",
  ],
  math: [
    ...
    "كيف تحسب التكامل المحدد لتطبيقات المساحة؟",
    "اشرح مفهوم النهايات في التفاضل والتكامل",
    "ما هي خصائص المصفوفات وعملياتها؟",
  ...
  arabic: [
    ...
    "ما هي أنواع الاستثناء وأدواته في اللغة العربية؟",
    "كيف تعرب الأسماء الخمسة؟",
    "اشرح قواعد كتابة الهمزة في وسط الكلمة",
    "ما الفرق بين الحال والتمييز في الإعراب؟",
...
const topicQuestions: Record<string, string[]> = {
  default: [
    "ما هو المفهوم الأساسي في هذا الموضوع؟",
    "كيف يمكن تطبيق هذا الموضوع في الحياة اليومية؟",
    "ما هي العوامل المؤثرة في هذا الموضوع؟",
    "اشرح العلاقة بين هذا الموضوع والموضوعات الأخرى",
    "ما هي أهم النظريات المرتبطة بهذا الموضوع؟",
    "كيف يمكن قياس النتائج في هذا الموضوع؟",
    "ما هي التحديات الشائعة في دراسة هذا الموضوع؟",
    "هل يمكنك ذكر مثال تطبيقي لهذا الموضوع؟",
    "ما هي المصادر الموثوقة لدراسة هذا الموضوع؟",
