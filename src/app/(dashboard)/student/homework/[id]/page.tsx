    ...
    return (
      <div className="p-4 md:p-6 text-center py-20">
        ...
        <Link href="/student/homework">
          <button type="button" variant="primary" rightIcon={<HiOutlineArrowRight className="w-4 h-4" />}>ط§ظ„ط¹ظˆط¯ط© ظ„ظ„ظˆط§ط¬ط¨ط§طھ</Button>
        </Link>
      </div>
    )
  }
      ...
      <div className="p-4 md:p-6 space-y-6">
        ...
        >
          <div className="lg:col-span-2 space-y-6">
            ...
            {submitted && (
              ...
              >
                ...
                <Link href="/student/homework">
                  <button type="button" variant="outline" rightIcon={<HiOutlineArrowRight className="w-4 h-4" />}>ط§ظ„ط¹ظˆط¯ط© ظ„ظ„ظˆط§ط¬ط¨ط§طھ</Button>
                </Link>
              </motion.div>
            )}
          </div>
          ...
          <div className="space-y-4">
            ...
            <Link href="/student/homework">
              <button type="button" variant="secondary" className="w-full" rightIcon={<HiOutlineArrowRight className="w-4 h-4" />}>
