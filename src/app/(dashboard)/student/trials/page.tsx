...
import {
  HiOutlinePlayCircle, HiOutlineClock, HiOutlineAcademicCap,
...
const trialLessons: TrialLesson[] = [
  { id: 1, title: "الكيمياء - الباب الأول: العناصر الانتقالية", subject: "كيمياء", teacher: "أ. خالد صقر", duration: 45, views: 3, maxViews: 5, rating: 4.9, watched: false, category: "video", description: "شرح كامل للعناصر الانتقالية وخواصها", color: "from-emerald-400 to-emerald-600" },
  { id: 2, title: "الفيزياء - الفصل الأول: التيار الكهربي", subject: "فيزياء", teacher: "أ. أحمد سمير", duration: 40, views: 2, maxViews: 5, rating: 4.8, watched: false, category: "video", description: "قوانين التيار الكهربي وطرق حسابه", color: "from-blue-400 to-blue-600" },
  { id: 3, title: "التفاضل - النهايات والاتصال", subject: "رياضيات", teacher: "أ. نبيل إبراهيم", duration: 35, views: 1, maxViews: 5, rating: 4.7, watched: false, category: "interactive", description: "تمارين تفاعلية على النهايات", color: "from-purple-400 to-purple-600" },
  { id: 4, title: "النحو - المبتدأ والخبر", subject: "عربي", teacher: "أ. محمد صلاح", duration: 30, views: 4, maxViews: 5, rating: 4.9, watched: true, category: "video", description: "قواعد المبتدأ والخبر مع الأمثلة", color: "from-amber-400 to-amber-600" },
  { id: 5, title: "Grammar - Present Tenses", subject: "إنجليزي", teacher: "أ. أحمد فريد", duration: 25, views: 0, maxViews: 5, rating: 4.5, watched: false, category: "interactive", description: "الأزمنة الحالية في اللغة الإنجليزية", color: "from-rose-400 to-rose-600" },
  { id: 6, title: "الكيمياء - الإتزان الكيميائي", subject: "كيمياء", teacher: "أ. محمود جلال", duration: 50, views: 2, maxViews: 3, rating: 4.6, watched: false, category: "pdf", description: "ملخص تفاعلات الإتزان مع التمارين", color: "from-cyan-400 to-cyan-600" },
  { id: 7, title: "الفيزياء الحديثة - مقدمة", subject: "فيزياء", teacher: "أ. مينا مجدي", duration: 30, views: 1, maxViews: 5, rating: 4.7, watched: false, category: "video", description: "نظريات الفيزياء الحديثة", color: "from-indigo-400 to-indigo-600" },
  { id: 8, title: "الأحياء - الخلية", subject: "أحياء", teacher: "أ. هاني جمعة", duration: 35, views: 0, maxViews: 5, rating: 4.4, watched: false, category: "interactive", description: "تركيب الخلية ووظائفها", color: "from-green-400 to-green-600" },
]
      ...
      <div className="p-4 md:p-6 max-w-6xl mx-auto space-y-6">
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
          <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-4 gap-3">
            <StatsCard title="الحصص المتاحة" value={lessons.length} icon={HiOutlinePlayCircle} color="primary" />
                  ...
                  <CardFooter className="p-3 pt-0">
                    ...
                    >
                      {playing === lesson.id ? (
                        ...
                        <><HiOutlinePlayCircle className="w-4 h-4" /> مشاهدة الحصة التجريبية</>
                      )}
                    </button>
                  </CardFooter>
                </Card>
          ...
          {filtered.length === 0 && (
            <div className="text-center py-16 text-text-tertiary">
              <HiOutlinePlayCircle className="w-16 h-16 mx-auto mb-3 opacity-30" />
